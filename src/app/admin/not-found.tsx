  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center">
      <div className="max-w-md mx-auto text-center px-4">
        ...
        <h1 className="text-3xl font-bold text-gray-900 mb-4">Admin Access Not Available</h1>
        
        <p className="text-gray-600 mb-8">
          The admin dashboard is only available through the portal subdomain. Please use the correct URL to access the HR admin panel.
        </p>
