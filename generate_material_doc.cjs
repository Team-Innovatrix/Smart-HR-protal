    ...
    children: [
      ...
      makeTable(
        ...
        [
          ...
          ["Auth Provider", "Clerk"],
          ["AI Engine", "OpenAI + LangChain + LangGraph"],
      ...
      makeTable(["Package", "Version", "What It Does"],
        [
          ["openai", "^5.12.2", "Direct OpenAI API client — used for GPT model calls"],
          ["@langchain/core", "^0.3.77", "Core abstractions for LangChain: chains, prompts, output parsers, memory"],
          ["@langchain/openai", "^0.6.13", "LangChain's OpenAI integration"],
      ...
      makeTable(["Variable", "Purpose"],
        [
          ["OPENAI_API_KEY", "API key for OpenAI GPT model calls"],
      ...
      bullet("Each node calls OpenAI GPT models via @langchain/openai"),
      ...
      makeTable(["Category", "Technology", "Role"],
        [
          ...
          ["AI — LLM", "OpenAI API", "GPT model calls"],
